    ...
    return new Promise(function (resolve, reject) {
        ...
        Follow.find({ 'userId': selfid }).populate({
            ...
            if (id == 'all') {
                ...
                var updateStr = { 'authorId': { '$in': arr }, 'status': 1 };
                ...
                //单个关注人的文章
                Article.find({ 'authorId': id, 'status': 1 }).populate('authorId', 'name headImage').skip(skipNum).limit(pageSize).sort({ 'createTime': -1 }).exec(function (err, art) {
